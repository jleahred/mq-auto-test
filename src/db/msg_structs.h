...
public:
    ...
    // constructor
    explicit sub_status (    const mtk::DateTime&  _started,   const int&  _repetitions,   const int&  _penalizations,   const int&  _options_per_question,   const int&  _failed,   const int&  _pendings );
    ...
    void check_recomended(void) const;
        ...
        public:
            ...
            explicit  sub_status__qpid_map (    const mtk::DateTime&  _started,   const int&  _repetitions,   const int&  _penalizations,   const int&  _options_per_question,   const int&  _failed,   const int&  _pendings );
