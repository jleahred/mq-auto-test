...
sub_status::sub_status (   const mtk::DateTime&  _started,   const int&  _repetitions,   const int&  _penalizations,   const int&  _options_per_question,   const int&  _failed,   const int&  _pendings)
    :     started(_started),   repetitions(_repetitions),   penalizations(_penalizations),   options_per_question(_options_per_question),   failed(_failed),   pendings(_pendings) 
...
sub_status__qpid_map::sub_status__qpid_map (   const mtk::DateTime&  _started,   const int&  _repetitions,   const int&  _penalizations,   const int&  _options_per_question,   const int&  _failed,   const int&  _pendings)
      :  m_static( 
   _started,
   _repetitions,
   _penalizations,
...
std::ostream& operator<< (std::ostream& o, const sub_status & c)
{
    o << "{ "
        ...
        << "started:"<<   c.started << "  "        << "repetitions:"<< c.repetitions<<"  "        << "penalizations:"<< c.penalizations<<"  "        << "options_per_question:"<< c.options_per_question<<"  "        << "failed:"<< c.failed<<"  "        << "pendings:"<< c.pendings<<"  "
        << " }";
    return o;
};
...
YAML::Emitter& operator << (YAML::Emitter& o, const sub_status & c)
{
    o << YAML::BeginMap
        ...
        << YAML::Key << "started"  << YAML::Value <<   c.started        << YAML::Key << "repetitions"  << YAML::Value << c.repetitions        << YAML::Key << "penalizations"  << YAML::Value << c.penalizations        << YAML::Key << "options_per_question"  << YAML::Value << c.options_per_question        << YAML::Key << "failed"  << YAML::Value << c.failed        << YAML::Key << "pendings"  << YAML::Value << c.pendings
        << YAML::EndMap;
    return o;
};
...
{
    return (          a.started ==  b.started  &&          a.repetitions ==  b.repetitions  &&          a.penalizations ==  b.penalizations  &&          a.options_per_question ==  b.options_per_question  &&          a.failed ==  b.failed  &&          a.pendings ==  b.pendings  &&   true  );
};
